...
<table class="invoice-table">
    ...
    @forelse($bills as $bill)
        ...
        <tr>
            ...
            <td class="right">{{ number_format($bill->weight, 2) }}</td>
            <td>{{ $monthName }}</td>
            <td class="right">{{ number_format($bill->value, 2) }}</td>
            <td class="right">{{ number_format($portBill, 2) }}</td>
            <td class="right">{{ number_format($totalBillAmount, 2) }}</td>
            <td class="right">{{ number_format($dfVat, 2) }}</td>
            <td class="right">{{ number_format($bill->doc_fee, 2) }}</td>
            <td class="right">{{ number_format($bill->scan_fee, 2) }}</td>
        </tr>
    @empty
        <tr>
