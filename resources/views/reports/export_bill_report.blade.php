...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            const originalBuyerId = "{{ $lastBill ? $lastBill->buyer_id : 'all' }}";
            const originalBeNo = "{{ $lastBill ? $lastBill->be_no : 'all' }}";
            const originalBillNo = "{{ $lastBill ? $lastBill->bill_no : 'all' }}";
            const originalBillDate = "{{ $lastBill ? \Carbon\Carbon::parse($lastBill->bill_date)->format('Y-m-d') : '' }}";
            ...
            $('#company, #buyer, #beNo, #billNo').on('change', function(){
